 ...
 * @author azaraf
 */
public class NuevoCodigoRazon extends javax.swing.JFrame {

    /**
     * Creates new form NuevaTarima1
     */
    public NuevoCodigoRazon() {
        ...
        public NuevoCodigoRazon(String nombre) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("   Nuevo Código de razón");
    ...
    private AccionesSubDivision codigo;
    ...
    private void aceptar() {
        nombre = jTextField2.getText();
            ...
            if (nuevo){
                ...
                AccionesSubDivision newC = new AccionesSubDivision();
                newC.setSubDivision(nombre);
