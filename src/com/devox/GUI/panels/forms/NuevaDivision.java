 ...
 * @author azaraf
 */
public class NuevaDivision extends javax.swing.JFrame {
    ...
    public NuevaDivision(String idDivision, String nombre) {
        ...
        jLabel3.setText("   Editar División");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("   Nueva División");
        ...
        labelData4.setText("ID división");
    ...
    private void aceptar() {
        ...
        if (nuevo) {
            ...
            AccionesFamilia newC = new AccionesFamilia();
            newC.setIdFamilia(nuevoId);
            newC.setDescripcion(nombre);
            ...
            fam.setCodigoFamilia(nuevoId);
            fam.setDescripcion(nombre);
            newC.cambio(idDivision, fam);
            insertado = true;
            this.dispose();
        }
    }
