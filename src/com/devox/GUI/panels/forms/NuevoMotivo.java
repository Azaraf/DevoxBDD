 ...
 * @author azaraf
 */
public class NuevoMotivo extends javax.swing.JFrame {
    ...
    public NuevoMotivo(int idMotivo, String descripcion) {
        nuevo = false;

        initComponents();
        this.idMotivo = idMotivo;
        jTextField1.setText(String.valueOf(idMotivo));
        jTextField2.setText(descripcion);
        jLabel3.setText("   Editar Motivo");
    ...
    private void aceptar() {
        int idNuevo = Integer.valueOf(jTextField1.getText());
        String desc = jTextField2.getText();

        if (nuevo) {
            //generar código para insertar
            AccionesMotivo accionesMotivo = new AccionesMotivo();
            accionesMotivo.setIdMotivo(idNuevo);
            accionesMotivo.setMotivo(desc);
            accionesMotivo.alta();
            insertado = true;
            this.dispose();
        } else {
            ...
            mot.setCodigo(idNuevo);
            mot.setDescripcion(desc);
            accionesMotivo.cambio(idMotivo, mot);
