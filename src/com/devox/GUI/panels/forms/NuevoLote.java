...
import org.inspira.devox.shared.Producto;
 ...
 * @author azaraf
 */
public class NuevoLote extends javax.swing.JFrame {
     ...
     */
    public NuevoLote() {
        lotes = new AccionesLote();
        listaProductos = new ArrayList<>();
        producto = new AccionesProducto();
        producto.loadDatabaseInstances();
        for (Shareable m : producto.getEntityInstances()) {
            listaProductos.add(((Producto) m).getCodigoLocal() + " – " + ((Producto)m).getDescripcion());
        }
        nuevo = true;
        initComponents();
    }

    public NuevoLote(String idProducto, String idLote, DevoxTableModel tabla, int r) {
        this.lot = idProducto;
        this.tabla = tabla;
        this.r = r;
        lotes = new AccionesLote();
        ...
        producto.loadDatabaseInstances();
        for (Shareable m : producto.getEntityInstances()) {
            listaProductos.add(((Producto) m).getCodigoLocal());
        }
        nuevo = false;

        initComponents();
        jLabel3.setText("Editar Lote");
        int x = 0;
        for (int i = 0; i < listaProductos.size(); i++) {
            if (idProducto.equals(listaProductos.get(i))) {
                x = i;
                break;
            }
        }
        ...
        loteViejo = new Lote();
        loteViejo.setCodigoLote(idLote);
        loteViejo.setProducto_idProducto(idProducto);
        jComboBox1.setSelectedIndex(x);
        textID.setText(idLote);
        textID.selectAll();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1 = new javax.swing.JComboBox(listaProductos.toArray(new Object[0]));
        ...
        labelData3.setText("Código de producto");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addComponent(labelData3, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelCampos, javax.swing.GroupLayout.DEFAULT_SIZE, 388, Short.MAX_VALUE)
    ...
    private AccionesProducto producto;
    private AccionesLote lotes;
    ...
    private void aceptar() {
        pro = jComboBox1.getSelectedItem().toString();
        String[] p = pro.split(" – ");
        lot = textID.getText();
        ...
        if (nuevo) {
            ...
            loteNuevo.setCodigoLote(lot);
            loteNuevo.setProducto_idProducto(p[0]);
            
            lotes.cambio(loteNuevo, loteViejo);
    ...
    private void setValue(String lot) {
        tabla.setValueAt(lot, r, 0);
    }
